...
//
  ...
  #define FAN1_PIN                   P2_04   // Remove the fan signal on pin P2_04 (example: SKR 1.4 Turbo HE1 plug)
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  0.1f       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 0.25f       // (steps or mm) Steps or millimeter distance for each XY babystep
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH               12   // (mm) Default retract length (positive value)
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       781        // (mA) RMS current. Multiply by 1.414 for peak current.
